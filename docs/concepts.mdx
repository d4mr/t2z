...
A **PCZT** is a standardized format defined in [ZIP 374](https://zips.z.cash/zip-0374) for building Zcash transactions incrementally across multiple parties or systems.
