...
It implements the [PCZT (Partially Constructed Zcash Transaction)](https://zips.z.cash/zip-0374) format defined in ZIP 374, enabling:
...
Full [ZIP 374](https://zips.z.cash/zip-0374) support allows transactions to be constructed across multiple parties, systems, or hardware devices.
...
- [ZIP 374](https://zips.z.cash/zip-0374) — Partially Constructed Zcash Transaction Format
